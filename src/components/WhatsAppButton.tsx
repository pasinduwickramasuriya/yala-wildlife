...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`
          mb-6 w-[340px] bg-neutral-900 rounded-[2.5rem] shadow-2xl overflow-hidden transition-all duration-400 ease-[cubic-bezier(0.68,-0.55,0.27,1.55)] origin-bottom-right border-4 border-neutral-800
      ...
      <button
        ...
        className={`
          relative flex items-center justify-center w-14 h-14 bg-[#00ff00] text-black rounded-[2rem] shadow-[0_8px_25px_rgba(0,255,0,0.3)] hover:shadow-[0_10px_40px_rgba(0,255,0,0.5)] transition-all duration-500 cubic-bezier(0.175, 0.885, 0.32, 1.275) z-20 
