...
// This ensures Vercel finds them. If the build fails, it means the files aren't in Git.
// Adjust the ../../ path if your component folder structure is different.
import imgYala1 from "../../public/uploads/yala.jpeg";
import imgYala2 from "../../public/uploads/yala1.webp";
import imgYala3 from "../../public/uploads/yala2.webp";

// --- DATA ---
const MEMORIES = [
  {
    id: 1,
    src: imgYala1, // Use the imported varia
    title: "The Apex Predator",
    location: "Block 1, Yala",
    tag: "Leopard Sighting",
    desc: "Our expert trackers know exactly where to find the elusive Sri Lankan Leopard."
  ...
  {
    id: 2,
    src: imgYala2, // Use the imported variable
    title: "Gentle Giants",
    location: "Waterhole 3",
    tag: "Elephant Herds",
    desc: "Witness the majesty of elephant families in their natural habitat from our safety-first jeeps."
  ...
  {
    id: 3,
    src: imgYala3, // Use the imported variable
    title: "The Safari Fleet",
    location: "Base Camp",
    tag: "Premium Service",
    desc: "Custom-modified luxury jeeps designed for photography, comfort, and maximum visibility."
            ...
            >
              ...
              <div className="absolute inset-0">
                <Image
                  ...
                  alt={item.title}
                  fill
                  placeholder="blur" // Added blur placeholder for better UX
                  className="object-cover transition-transform duration-1000 ease-out group-hover:scale-110"
                />
                {/* Gradient Overlay (Always visible for text readability) */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500" />
