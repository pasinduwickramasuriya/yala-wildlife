...
// import { FaCheckCircle, FaChevronDown, FaSpinner } from 'react-icons/fa'; // Added FaSpinner
...
//             className="w-full sm:w-auto text-center bg-[#00ff00] text-black rounded-full px-10 py-4 text-base font-bold hover:bg-green-500 hover:-translate-y-1 shadow-lg hover:shadow-green-500/40 transition-all duration-300 flex-shrink-0"
//         >
//             Write a review
//         </a>
//     </div>
...
//     // REMOVED: Blocking loading state (if (loading) return null;)
//     // This was causing the "stuck" screen. 
//     // Now we render the background/structure immediately.
...
//                 {/* Header loads immediately even if data is fetching */}
...
//                     {/* Conditional Rendering: Show Spinner if loading, Cards if loaded */}
//                     {loading ? (
...
//                             className="group flex flex-col items-center gap-2 text-neutral-400 hover:text-black transition-colors duration-300 focus:outline-none"
//                         >
//                             <span className="text-sm uppercase tracking-widest font-bold bg-neutral-900/50 backdrop-blur-md border border-white/10 px-8 py-3 rounded-full group-hover:bg-[#00ff00] group-hover:border-[#00ff00] transition-all duration-300 shadow-xl">
//                                 Load More Reviews
//                             </span>
