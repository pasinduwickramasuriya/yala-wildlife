...
const ModernHeader = ({ reviewCount }: { reviewCount: number }) => (
    <header className="mb-10 w-full flex flex-col md:flex-row items-center justify-center bg-black/40 backdrop-blur-md rounded-3xl p-6 sm:p-8 gap-8 md:gap-12 border border-white/5 text-center md:text-left">
        ...
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#00ff00] text-black rounded-full px-8 py-3 text-sm font-bold uppercase tracking-widest transition-transform active:scale-95 shadow-lg shadow-[#00ff00]/10 shrink-0"
        >
            Write a Review
        </a>
    </header>
...
const SummaryCard = () => (
    <article className="flex flex-col bg-black/40 backdrop-blur-md rounded-3xl p-6 border border-white/5">
...
const ReviewCard = ({ review }: { review: Review }) => {
    ...
    return (
        <article className="inline-block w-full break-inside-avoid mb-6 bg-black/30 backdrop-blur-sm rounded-3xl p-6 border border-white/5">
            <div className="flex items-center gap-3 mb-4">
                ...
                {!loading && visibleCount < allReviews.length && (
                    <div className="flex justify-center mt-10">
                        <button
                            ...
                            className="text-[11px] uppercase tracking-[0.4em] font-black text-white/50 hover:text-[#00ff00] transition-all flex flex-col items-center gap-3 group"
                        >
                            View Entire Gallery Feed
                            <FaChevronDown className="group-hover:translate-y-1 transition-transform animate-bounce text-[#00ff00]" />
                        </button>
                    </div>
                )}
            </div>
