...
import { Heart, ArrowUpRight, Camera } from "lucide-react";
...
const GallerySection = () => {
  const images = [
    {
      id: 1,
      url: "https://res.cloudinary.com/dkfnpmzpv/image/upload/v1771401761/hero_sections/dcjjvovjfbgidkiydjgw.jpg",
      title: "Birds ",
    ...
    {
      id: 2,
      url: "https://res.cloudinary.com/dkfnpmzpv/image/upload/v1770187749/blogs/pksnkuygrovny2mzj48h.jpg",
      title: "Gentle Giants",
    ...
    {
      id: 4,
      url: "https://res.cloudinary.com/dkfnpmzpv/image/upload/v1764856025/blogs/jolr8n1f4vtbcnvhszkj.png",
      title: "Safari Vibes",
    ...
    <section className="py-24 bg overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <p className="text-white max-w-md text-sm md:text-base leading-relaxed text-left md:text-right     inline-block px-4 py-2 rounded-3xl bg-black/70">
